let alturaPedro = 1.5;//2.3
                        //40
let alturaLucas = 1.1;//2.3
...
for (anos; alturaLucas <= alturaPedro; anos++){
...
altura Pedro: ${alturaPedro.toFixed(2)}m <br>
altura Lucas: ${alturaPedro.toFixed(2)}m`  )
